...
\usepackage{enumitem}
\usepackage{fontspec}
\usepackage{underscore} % 解决下划线问题
\usepackage{amsthm}     % 添加amsthm包以支持definition环境

% 定义定理环境
\newtheorem{definition}{定义}

\setmainfont{SimSun} % 或其他安装在您系统上的中文字体
\definecolor{codeblue}{RGB}{0, 0, 255}

% 修改lean命令，避免使用\verb
\newcommand{\lean}[1]{{\color{codeblue}\texttt{\detokenize{#1}}}}
\newcommand{\leanok}{\textbf{✓}}
\newcommand{\uses}[1]{\textit{依赖: #1}}
